...
<head>
    ...
    <title>Log In Employer | Work24HR</title>
...
<body class="__hero-img">
    ...
    <div class="bx mb-3">
        <div class="container">
            ...
            <p class="mb-4"><b class="text_ct">Employer Login Area</b></p>
            <p class="text-muted ">Don't have an account? <a class="text_create" href="https://www.work24hr.com/employer-registration">Create free account</a> </p>
            <div class=" row ">
                <div class="col-lg-6">
                    <form action="" method="POST" id="log_form">
                        ...
                        <div class="d-grid gap-2">
                            <button class="btn btn-dark p-3 b" id="submit_btn" type="button">LOG IN &nbsp;<span id="spin" class="float-end">
                                    <div class="clearfix">
