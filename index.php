...
<body>
                        ...
                        ?>
                            ...
                            <div class="single-job-items mb-30">
                                <div class="job-items">
                                    <div class="company-img">
                                        <a href="job_details.php?job=<?php echo $row['jobid']; ?>">
                                            <img src="./employer/upload/<?php echo $row['companylogo']; ?>" style="border: 1px solid #fac5a2;" alt="" />
                                        </a>
                                    </div>
                                ...
                                <div class="items-link f-right">
                                    <a href="job_details.php"><?php echo $row['wtype']; ?></a>
                                    <span>
    ...
    <script defer src="https://static.cloudflareinsights.com/beacon.min.js/vaafb692b2aea4879b33c060e79fe94621666317369993" integrity="sha512-0ahDYl866UMhKuYcW078ScMalXqtFJggm7TmlUtp0UlD4eQk0Ixfnm5ykXKvGJNFjLMoortdseTfsRT8oCfgGA==" data-cf-beacon='{"rayId":"76d368598dde94fa","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2022.11.0","si":100}' crossorigin="anonymous"></script>
