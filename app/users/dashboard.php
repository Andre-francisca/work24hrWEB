                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-white">
                                            ...
                                            <!--<?php   echo '$'.number_format(3333333, 2, '.', ','); ?>-->
                                        
                                        </div>
                                    </div>
                                    <div class="col-auto">
                                        <i class="ti-bar-chart-alt text-gray-300"  style="font-size:60px;color:#fff"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card bg-dark  shadow h-100 py-2" style="border-bottom:3px solid #6fa491">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold  text-uppercase mb-1" style="color:#6fa491">Wallet</div>
                                        <div class="h5 mb-0 font-weight-bold text-white">$<?php echo number_format(100000, 2, '.', ','); ?></div>
                                    </div>
                                    <div class="col-auto">
                                        <i class="ti-credit-card text-gray-300" style="font-size:60px;color:#fff" ></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card bg-dark  shadow h-100 py-2" style="border-bottom:3px solid #6fa491">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold  text-uppercase mb-1" style="color:#6fa491">Total Confirmed Deposit
                                        </div>
                                        <div class="row no-gutters align-items-center">
                                            <div class="col-auto">
                                                <div class="h5 mb-0 mr-3 font-weight-bold text-white">$<?php echo 00 ?></div>
                                            </div>
                        ...
                        <div class="card bg-dark  shadow h-100 py-2" style="border-bottom:3px solid #6fa491">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold  text-uppercase mb-1" style="color:#6fa491">
                                           Total Confirmed Withdrawal</div>
                                        <div class="h5 mb-0 font-weight-bold text-white">$<?php echo number_format(333333, 2, '.', ',');?></div>
                                    </div>
                                    <div class="col-auto">
                                        <i class="ti-stats-up text-gray-300" style="font-size:60px;color:#fff"></i>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold  text-uppercase mb-1" style="color:#6fa491">
                                           Referral Bonus</div>
                                        <div class="h5 mb-0 font-weight-bold text-white">$<?php echo number_format(444, 2, '.', ',') ; ?></div>
                                    </div>
                                    <div class="col-auto">
                                        <i class="ti-exchange-vertical fa-2x text-gray-300" style="font-size:60px;color:#fff"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
